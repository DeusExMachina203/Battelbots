...
void CArena:: encaminar_bot(Tipo_tablero pos, vector<Tipo_tablero> Labierta, vector<Tipo_tablero> Lcerrada) {
    Tipo_tablero posfinal= (ancho * alto)-1;
    if (((int)pos/ancho) == 0 and pos-(((int)pos/ancho)*ancho) == 0) {
        if (!comprobador(Lcerrada, pos + ancho) ){
            if (comprobador(Labierta,pos+ancho)){
                if(tabo[((int)pos/ancho) + 1][pos-(((int)pos/ancho)*ancho)][2] > tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)][2]+10){
                ...
                tabo[((int) pos / ancho) + 1][(pos - (((int) pos / ancho) * ancho))][1] = abs(
        ...
        if (!comprobador(Lcerrada, pos + 1)) {
            if (comprobador(Labierta,pos+ancho)){
                if(tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)+1][2] < tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)][2]+10){
                ...
                tabo[((int) pos / ancho)][(pos - (((int) pos / ancho) * ancho)) + 1][1] = abs(
                        ((((int) posfinal / ancho) - (((int) pos / ancho)))) +
                        ((posfinal - (((int) pos / ancho) * ancho)) - (pos - ((((int) pos / ancho) * ancho) + 1))));
                tabo[((int) pos / ancho)][(pos - (((int) pos / ancho) * ancho)) + 1][2] += 10;
                Labierta.push_back(tabo[((int) pos / ancho)][pos - (((int) pos / ancho) * ancho) + 1][0]);
                tabo[((int) pos / ancho)][pos - (((int) pos / ancho) * ancho) + 1][3] = ((int) pos / ancho);
                tabo[((int) pos / ancho)][pos - (((int) pos / ancho) * ancho) + 1][4] =
                        pos - (((int) pos / ancho) * ancho);
            }
        }
        ...
        if (!comprobador(Lcerrada, pos -ancho)) {
            if (comprobador(Labierta,pos+ancho)){
                ...
                tabo[((int) pos / ancho) - 1][(pos - (((int) pos / ancho) * ancho))][1] = abs(
                        ((((int) posfinal / ancho) - (((int) pos / ancho) - 1))) +
                        ((posfinal - (((int) pos / ancho) * ancho)) - (pos - ((((int) pos / ancho) * ancho)))));
                tabo[((int) pos / ancho) - 1][pos - ((int) pos / ancho)][2] += 10;
                Labierta.push_back(tabo[((int) pos / ancho) - 1][pos - (((int) pos / ancho) * ancho)][0]);
                tabo[((int) pos / ancho) - 1][pos - (((int) pos / ancho) * ancho)][3] = ((int) pos / ancho);
                tabo[((int) pos / ancho) - 1][pos - (((int) pos / ancho) * ancho)][4] =
                        pos - (((int) pos / ancho) * ancho);
            }
        }
        ...
        if (!comprobador(Lcerrada, pos + 1)) {
            if (comprobador(Labierta,pos+ancho)){
                if(tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)+1][0] < tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)][2]+10){
                    tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)+1][3]=((int)pos/ancho);
                    tabo[((int)pos/ancho)][pos-(((int)pos/ancho)*ancho)+1][4]=pos-(((int)pos/ancho)*ancho);
                }
            }
    ...
    if (Labierta.empty()){
        ...
        if (proxpos + ancho == ((alto*ancho)-1) or proxpos + 1 == ((alto*ancho)-1)){
            ...
            Lcerrada.push_back(proxpos);
            removedor(Labierta, proxpos);
            encaminar_bot(proxpos, Labierta, Lcerrada);
        }
    }
